...
const TREE_DATA = {
  'Invoices': [
    'McMurray Stern Inc. Pmt. Pkg. P0114682 Inv.26108 AC.pdf',    
  ],
  'Contract': [
    'McMurray Stern Inc. P0114682  1st Floor Warehouse AC.pdf',    
  ]
 ...
 */
@Component({
  selector: 'asso-attach',
  templateUrl: './asso-attach.component.html',
  styleUrls: ['./asso-attach.component.scss'],
  providers: [ChecklistDatabase]
})
export class AssoAttachComponent {
