...
@Component({
  selector: 'app-expansion-one',
  templateUrl: './expansion-one.component.html',
  styleUrls: ['./expansion-one.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ExpansionOneComponent implements OnInit {
